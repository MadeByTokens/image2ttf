...
4. **Preview** → traces glyphs (Detail slider 1-10 for point count, Smoothing slider 0-5 for Chaikin corner-cutting), glyph gallery with SVG inspect/retrace/delete, kerning pair editor, live font preview via `@font-face` blob URL with GPOS+kern tables
